...
# Preloaded dataset
st.write("Using a preloaded dataset for prediction.")
...
data = pd.DataFrame({
    ...
    "Rest BP": [145, 130, 130, 120, 140],
    "Exercise Heart Rate": [150, 187, 172, 178, 163],
    "Old Peak": [2.3, 3.5, 1.4, 0.8, 0.6],
    "FBS": [1, 0, 0, 0, 0],
    "EI Angina": [0, 0, 0, 1, 0],
    "CA": [0, 0, 0, 0, 0],
    "Asymptomatic": [1, 0, 1, 1, 1],
    "Atypical Angina": [0, 1, 0, 0, 0],
    "Non-Anginal": [0, 0, 1, 0, 0],
    "Typical Angina": [0, 0, 0, 0, 0],
    "LV Hypertrophy": [0, 0, 1, 0, 0],
    "Normal (ECG)": [0, 1, 0, 0, 0],
    "ST-T Abnormality": [1, 0, 1, 1, 1],
    "Downsloping": [0, 0, 0, 1, 0],
    "Flat": [1, 1, 1, 0, 1],
    "Upsloping": [0, 0, 0, 0, 0],
    "Fixed Defect": [0, 0, 0, 0, 0],
    "Normal (Thal)": [0, 0, 0, 0, 0],
    "Reversable Defect": [1, 1, 1, 1, 1],
    "Severity": [0, 1, 2, 3, 4],
})
